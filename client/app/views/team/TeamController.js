...
twinsoftApp.controller('TeamController', function TeamController($scope) {
	 ...
	 */
	$scope.team = [
	    {name: 'Miodrag Pavković', title: 'CEO', img: 'app/images/team/mio.jpg', description: 'Full stack developer'},
      ...
      //{name: 'Aleksandar Krompić', title: 'Software Developer', img: 'app/images/team/krompa.jpg', description: 'C# expert'},
	];
